...
class TestMorphSegPerformance:
    """Test performance characteristics of morphseg processor"""
    ...
    def test_incremental_processing(self):
        ...
        doc1 = nlp("First sentence.")
        doc2 = nlp("Second sentence.")
        doc3 = nlp("Third sentence.")
